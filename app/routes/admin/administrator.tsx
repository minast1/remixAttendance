...
import { Link, LoaderFunction, Outlet, useLoaderData, useLocation, useNavigate} from 'remix';
      ...
      <Container maxWidth="lg" sx={{ mt: 5 }}>
         ...
         <Card sx={{ mb: 10 }}>
          <CardHeader
            ...
            <Typography variant="h5" sx={{mt:2, mr:1}}>Course Management Area</Typography>
             <img style={{height: 45, width: 40}} alt="attendance" src="/graduation.png" />
            </Box >
        }
          ...
          <CardContent sx={{ borderTop: '1px solid lightgray' }}>
            ...
            <CardActions>
                  <Button 
                   ...
                   size="small" 
                      component={Link}
                      to="/admin/administrator/createcourse">Create new Course</Button>
            </CardActions>
        </Card>
        </Container>
